...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.UI","com.vaadin.ui.DateField","com.vaadin.ui.Window","com.vaadin.ui.Form","com.vaadin.ui.Slider","com.vaadin.ui.Embedded","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.TextArea","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.NativeSelect","com.vaadin.ui.Table","com.vaadin.ui.FormLayout","com.vaadin.ui.InlineDateField","com.vaadin.ui.Video","com.vaadin.ui.GridLayout","com.vaadin.ui.Tree","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.OptionGroup","com.vaadin.ui.PasswordField","com.vaadin.ui.ListSelect","com.vaadin.ui.ComboBox","com.vaadin.ui.Panel","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.TabSheet","com.vaadin.ui.CssLayout","com.vaadin.ui.TextField","com.vaadin.ui.CustomField","com.vaadin.ui.NativeButton","com.vaadin.ui.CustomComponent","com.vaadin.ui.PopupView","com.vaadin.ui.JavaScript","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Flash","com.vaadin.server.FileDownloader","com.vaadin.ui.Button","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Link","com.vaadin.ui.Accordion","com.vaadin.ui.TreeTable","com.vaadin.ui.MenuBar","com.vaadin.ui.Upload","com.vaadin.ui.CheckBox","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Label","com.vaadin.ui.Image","com.vaadin.ui.CustomLayout","com.vaadin.ui.BrowserFrame","com.vaadin.ui.TwinColSelect","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Audio","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.HorizontalLayout",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"resources", "errorMessage", "codetype", "codebase", "archive", "enabled", "alternateText", "styles", "description", "id", "standby", "immediate", "registeredEventListeners", "caption", "width", "embedParams", "readOnly", "classId", "height", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"clientX", "relativeY", "clientY", "relativeX", "button", "ctrlKey", "shiftKey", "type", "altKey", "metaKey", });
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"enabled", "errorMessage", "registeredEventListeners", "styles", "resources", "caption", "primaryStyleName", "hideErrors", "required", "readOnly", "id", "tabIndex", "width", "description", "height", "modified", "propertyReadOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"id", "description", "styles", "minValue", "errorMessage", "registeredEventListeners", "value", "required", "propertyReadOnly", "resources", "height", "enabled", "caption", "width", "maxValue", "hideErrors", "immediate", "orientation", "modified", "readOnly", "tabIndex", "resolution", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"primaryStyleName", "templateContents", "errorMessage", "templateName", "immediate", "id", "enabled", "registeredEventListeners", "resources", "caption", "height", "styles", "description", "childLocations", "readOnly", "width", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"enabled", "readOnly", "marginsBitmask", "childData", "height", "immediate", "width", "description", "id", "resources", "primaryStyleName", "registeredEventListeners", "spacing", "errorMessage", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"primaryStyleName", "resources", "maxLength", "hideErrors", "text", "width", "registeredEventListeners", "id", "inputPrompt", "columns", "modified", "height", "enabled", "description", "immediate", "propertyReadOnly", "caption", "required", "readOnly", "styles", "tabIndex", "errorMessage", });
            ...
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"enabled", "alternateText", "primaryStyleName", "height", "width", "resources", "caption", "readOnly", "errorMessage", "immediate", "description", "registeredEventListeners", "styles", "id", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"spacing", "caption", "width", "height", "immediate", "resources", "primaryStyleName", "registeredEventListeners", "marginsBitmask", "enabled", "styles", "readOnly", "description", "errorMessage", "childData", "id", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"id", "styles", "propertyReadOnly", "description", "height", "caption", "primaryStyleName", "hideErrors", "width", "modified", "immediate", "errorMessage", "tabIndex", "required", "readOnly", "registeredEventListeners", "enabled", "resources", });
            ...
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"styles", "hideErrors", "required", "modified", "pollingInterval", "indeterminate", "propertyReadOnly", "width", "errorMessage", "id", "description", "readOnly", "state", "registeredEventListeners", "resources", "immediate", "caption", "height", "primaryStyleName", "enabled", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"immediate", "positionX", "positionY", "resources", "tabIndex", "scrollLeft", "caption", "scrollTop", "width", "draggable", "primaryStyleName", "modal", "resizeLazy", "description", "registeredEventListeners", "errorMessage", "readOnly", "resizable", "enabled", "id", "height", "styles", "centered", });
            ...
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"styles", "immediate", "id", "htmlContentAllowed", "tabIndex", "primaryStyleName", "width", "registeredEventListeners", "resources", "disableOnClick", "errorMessage", "clickShortcutKeyCode", "height", "readOnly", "enabled", "caption", "description", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"registeredEventListeners", "modified", "checked", "description", "propertyReadOnly", "immediate", "id", "errorMessage", "caption", "width", "primaryStyleName", "tabIndex", "enabled", "styles", "hideErrors", "height", "readOnly", "resources", "required", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"resources", "width", "registeredEventListeners", "secondChild", "immediate", "firstChild", "description", "height", "id", "caption", "readOnly", "enabled", "splitterState", "errorMessage", "primaryStyleName", "styles", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"propertyReadOnly", "required", "modified", "resources", "width", "primaryStyleName", "caption", "errorMessage", "height", "readOnly", "tabIndex", "styles", "id", "hideErrors", "description", "enabled", "immediate", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"rpcInterfaces", "immediate", "registeredEventListeners", "enabled", "description", "height", "styles", "resources", "readOnly", "caption", "primaryStyleName", "width", "errorMessage", "id", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"tabIndex", "id", "readOnly", "primaryStyleName", "enabled", "styles", "immediate", "description", "resources", "height", "errorMessage", "registeredEventListeners", "width", "caption", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"errorMessage", "description", "registeredEventListeners", "resources", "propertyReadOnly", "layout", "width", "readOnly", "enabled", "primaryStyleName", "tabIndex", "id", "caption", "footer", "modified", "required", "immediate", "styles", "hideErrors", "height", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"enabled", "hideErrors", "propertyReadOnly", "primaryStyleName", "resources", "width", "immediate", "caption", "styles", "errorMessage", "height", "id", "registeredEventListeners", "modified", "required", "description", "tabIndex", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"registeredEventListeners", "modified", "resources", "errorMessage", "enabled", "caption", "required", "styles", "hideErrors", "id", "height", "immediate", "description", "width", "readOnly", "propertyReadOnly", "primaryStyleName", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"primaryStyleName", "immediate", "id", "enabled", "caption", "registeredEventListeners", "description", "resources", "errorMessage", "styles", "childCss", "width", "readOnly", "height", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"height", "width", "styles", "immediate", "caption", "id", "connectorToCssPosition", "registeredEventListeners", "readOnly", "primaryStyleName", "description", "resources", "errorMessage", "enabled", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"styles", "hideErrors", "immediate", "registeredEventListeners", "width", "readOnly", "propertyReadOnly", "modified", "resources", "required", "tabIndex", "errorMessage", "height", "description", "caption", "id", "primaryStyleName", "enabled", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"immediate", "primaryStyleName", "spacing", "marginsBitmask", "description", "columns", "caption", "styles", "registeredEventListeners", "rows", "enabled", "childData", "width", "id", "height", "resources", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"resources", "hideErrors", "modified", "styles", "width", "caption", "textFieldEnabled", "tabIndex", "registeredEventListeners", "propertyReadOnly", "description", "errorMessage", "primaryStyleName", "readOnly", "height", "required", "enabled", "id", "immediate", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"registeredEventListeners", "resources", "immediate", "description", "readOnly", "errorMessage", "enabled", "height", "id", "alternateText", "width", "caption", "primaryStyleName", "styles", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"id", "immediate", "caption", "resources", "styles", "height", "enabled", "errorMessage", "readOnly", "primaryStyleName", "description", "width", "registeredEventListeners", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "readOnly", "enabled", "errorMessage", "htmlContentAllowed", "width", "description", "caption", "resources", "registeredEventListeners", "clickShortcutKeyCode", "disableOnClick", "immediate", "height", "tabIndex", "styles", "id", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"required", "modified", "width", "errorMessage", "styles", "id", "immediate", "propertyReadOnly", "height", "hideErrors", "tabIndex", "resources", "enabled", "registeredEventListeners", "caption", "primaryStyleName", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"hideErrors", "registeredEventListeners", "width", "errorMessage", "columns", "required", "height", "immediate", "rows", "propertyReadOnly", "resources", "maxLength", "caption", "readOnly", "inputPrompt", "description", "tabIndex", "wordwrap", "text", "styles", "primaryStyleName", "enabled", "modified", "id", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"alternateText", "resources", "id", "height", "errorMessage", "width", "readOnly", "immediate", "description", "primaryStyleName", "registeredEventListeners", "styles", "enabled", "caption", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"minPosition", "positionReversed", "maxPositionUnit", "locked", "maxPosition", "minPositionUnit", "positionUnit", "position", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"caption", "immediate", "enabled", "htmlContentAllowed", "registeredEventListeners", "height", "errorMessage", "muted", "width", "showControls", "primaryStyleName", "sources", "resources", "styles", "sourceTypes", "id", "altText", "readOnly", "description", "autoplay", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"caption", "muted", "altText", "immediate", "htmlContentAllowed", "errorMessage", "autoplay", "height", "showControls", "styles", "description", "resources", "id", "registeredEventListeners", "sources", "enabled", "primaryStyleName", "readOnly", "width", "sourceTypes", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"immediate", "tabIndex", "resources", "readOnly", "height", "styles", "registeredEventListeners", "description", "scrollLeft", "primaryStyleName", "scrollTop", "width", "caption", "enabled", "errorMessage", "id", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"readOnly", "id", "errorMessage", "width", "description", "resources", "styles", "enabled", "height", "registeredEventListeners", "spacing", "primaryStyleName", "marginsBitmask", "immediate", "caption", "childData", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"primaryStyleName", "caption", "width", "height", "errorMessage", "registeredEventListeners", "styles", "enabled", "immediate", "text", "resources", "readOnly", "id", "contentMode", "description", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"immediate", "height", "caption", "parameters", "description", "styles", "width", "registeredEventListeners", "target", "id", "readOnly", "enabled", "errorMessage", "resources", "primaryStyleName", "uriFragment", "features", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"description", "immediate", "resources", "enabled", "registeredEventListeners", "styles", "errorMessage", "width", "primaryStyleName", "id", "height", "caption", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"primaryStyleName", "immediate", "styles", "hideOnMouseOut", "height", "errorMessage", "width", "readOnly", "caption", "html", "enabled", "id", "registeredEventListeners", "description", "resources", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"caption", "firstChild", "height", "styles", "enabled", "primaryStyleName", "immediate", "id", "readOnly", "secondChild", "description", "resources", "splitterState", "registeredEventListeners", "errorMessage", "width", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"resources", "caption", "id", "registeredEventListeners", "enabled", "width", "styles", "height", "errorMessage", "primaryStyleName", "description", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"immediate", "registeredEventListeners", "enabled", "tabIndex", "caption", "resources", "required", "description", "id", "propertyReadOnly", "modified", "readOnly", "errorMessage", "hideErrors", "primaryStyleName", "width", "styles", "height", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"immediate", "styles", "registeredEventListeners", "height", "id", "width", "description", "enabled", "readOnly", "caption", "errorMessage", "primaryStyleName", "resources", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"readOnly", "id", "description", "bgColor", "errorMessage", "styles", "primaryStyleName", "cursorY", "height", "cursorX", "resources", "immediate", "enabled", "registeredEventListeners", "caption", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"registeredEventListeners", "errorMessage", "enabled", "caption", "color", "height", "popupVisible", "styles", "readOnly", "resources", "immediate", "width", "description", "showDefaultCaption", "htmlContentAllowed", "id", "primaryStyleName", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"resources", "columnCount", "changedColor", "rowCount", "errorMessage", "width", "immediate", "caption", "styles", "registeredEventListeners", "id", "enabled", "changedX", "changedY", "description", "height", "readOnly", "primaryStyleName", });
